...
void Custom_PmicRegisterInit(void) {
    ...
    // S3-Touch-AMOLED-1.75C: ALDO1 powers the ES7210 microphone array.
    // Setting the voltage alone does not enable the rail; the XiaoZhi board
    // package for this board enables it explicitly (AXP2101 reg 0x90 bit0).
    axp2101.enableALDO1();
}
